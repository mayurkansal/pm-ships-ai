...
| 04 | Spec review & pre-design | [Red-Team Agent](agents/04-redteam-agent) | ✅ shipped |

More stages (build enablement, testing, stakeholder alignment, launch, measurement, feedback synthesis, prioritization) are coming — one agent, one story, one week at a time.
