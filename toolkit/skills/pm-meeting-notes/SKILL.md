...
description: Turns raw meeting notes or a transcript into a structured summary with clear owners and due dates for each action item. Use this skill whenever the user pastes in meeting notes, a transcript, or rough notes from a call and wants them organized, or mentions needing to follow up on action items from a meeting.
---
