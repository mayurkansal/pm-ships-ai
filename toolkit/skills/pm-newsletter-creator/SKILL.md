---
name: pm-newsletter-creator
description: Builds a fully styled, email-client-safe HTML newsletter from quarterly content like highlights, metrics, wins, and team moments. Use this skill whenever the user wants to create a team or product newsletter, especially one that needs to be sent as HTML email.
---
