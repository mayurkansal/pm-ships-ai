---
name: pm-uat-cases
description: Generates structured, unambiguous, directly testable UAT test cases from a feature or project description, grouped by happy path, negative/error handling, boundary conditions, and permissions. Use this skill whenever the user needs test cases for a feature, mentions UAT, QA testing, or acceptance testing, or is preparing to hand a feature off for testing.
---
