---
name: pm-voc-analyser
description: Synthesizes raw Voice of Customer feedback -- support tickets, NPS responses, survey comments, app reviews -- into a structured report with sentiment breakdown, top themes, a priority matrix, and quick wins. Use this skill whenever the user has customer feedback data and wants it analyzed, or mentions VOC, NPS, or customer sentiment analysis.
---
