---
name: pm-prd-writer
description: Generates a complete, structured PRD end-to-end from a rough feature idea, user story, or brief -- gathering inputs (problem, personas, scope, success metrics, dependencies) before writing, then producing a full PRD ready for engineering handoff. Use this skill whenever the user wants a full PRD created from scratch, mentions a new feature idea and needs it turned into a formal spec, or is preparing to hand a feature off to engineering.
---
