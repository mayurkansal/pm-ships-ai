...
description: Turns bullet points or rough progress notes into a polished stakeholder status update, in both a short Slack-style version and a longer email/doc version. Use this skill whenever the user needs to write a status update, progress report, or update for leadership or stakeholders.
---
