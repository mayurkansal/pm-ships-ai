---
name: pm-jira-ticket-writer
description: Converts a plain-English feature or bug description into a single formatted Jira ticket. Use this skill whenever the user gives a quick, informal description of a bug or feature and wants it turned into one proper Jira ticket, without needing the full multi-issue-type Epic/Story/Bug/Task workflow.
---
