---
name: pm-folder-cleaner
description: Scans a folder and proposes -- then, only after confirmation, executes -- a clean re-organization by file type, date, or topic, always dry-run first and never deleting files. Use this skill whenever the user wants to clean up, organize, or tidy a messy folder or workspace.
---
