---
name: pm-presentation-creator
description: Converts raw notes, a topic, or an existing PPTX into a polished, fully self-contained HTML slide deck with navigation and consistent visual design. Use this skill whenever the user wants to create a presentation or slide deck, or needs to convert notes or a PPTX into slides.
---
